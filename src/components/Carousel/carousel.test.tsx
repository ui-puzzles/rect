...
describe('Carousel', () => {
  it('render default correctly', () => {
    const wrapper = render(<Carousel {...defaultProps}>
      <Carousel.Item>
    ...
    const ctrlLeftElem = carouselElem?.querySelector('.pr-carousel-ctrl-left') as HTMLDivElement;
    const dotElem = carouselElem?.querySelector('.pr-carousel-dot') as HTMLSpanElement;
    ...
    expect(wrapperElem?.firstChild).toHaveClass('pr-carousel-item pr-carousel-item-active');
